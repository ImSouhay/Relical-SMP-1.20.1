...
public class Main extends JavaPlugin {
    ...
    public void onEnable() {
        ...
        System.out.println("[Relical-SMP-plugin] Made By Souhay, Minecraft IGN: ImSouhay, Discord: moonsouhay, Github: https://github.com/ImSouhay .");
        CustomRelics.makeCustomItems();
        getServer().getPluginManager().registerEvents(new EventListener(), this);
        getCommand("RelicalGive").setExecutor(new RelicalGiveListener());
    }
